            ...
            <div className="m-auto w-[85%] pb-[5%]">
                <div className="pt-8 ">
                    ...
                    <div className="md:flex items-cente gap-10 justify-between my-3">
                        <div className="w-[100%]">
                            {!tab && <div className="space-y-16 overflow-y-scroll h-[100vh]">
                                <div className="flex items-center bg-white w-[100%] rounded-xl ">
                                    <div className="">
                                        <img src="" alt="" className="aviation rounded-l-xl" />
                                    </div>
                                ...
                                <div className="flex items-center bg-white w-[100%] rounded-xl ">
                                    <div className="">
                                        <img src="" alt="" className="aviation2 rounded-l-xl" />
                                    </div>
                                    <div className="w-[250px] text-center">
                                ...
                                <div className="flex items-center bg-white w-[100%] rounded-xl ">
                                    <div className="">
                                        <img src="" alt="" className="aviation3 rounded-l-xl" />
                                    </div>
                                    <div className="w-[250px] text-center">
                        ...
                        {!tab && <div className="space-y-3 w-[100%] bg-white">
                            <img src="" alt="" className="aviation-big" />
                        ...
                        {tab && <div className="space-y-3 w-[100%] bg-white">
                            <img src="" alt="" className="electricity-big" />
                            <div className="p-5 space-y-3">
